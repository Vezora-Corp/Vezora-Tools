...
adapter_path = 'C:/Users/PC/Desktop/oobabooga_windows/text-generation-webui/loras/13bWizardCodeUnderstandingNEWW/checkpoint-1064'
...
try:
    ...
    model = dequantize_model(model, tok, to='C:/Users/PC/Desktop/oobabooga_windows/text-generation-webui/models/nawrwhalee')
    print(model)
