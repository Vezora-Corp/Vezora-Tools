...
parser = argparse.ArgumentParser(description='Merge model with LoRA adapter.')
...
model_path = 'C:/Users/PC/Desktop/oobabooga_windows/text-generation-webui/models/WizardCoder-Python-13B-V1.0'
adapter_path = 'C:/Users/PC/Desktop/oobabooga_windows/text-generation-webui/loras/13bWizardCodeUnderstanding15/checkpoint-1404'
...
try:
    ...
    model = dequantize_model(model, tok, to='C:/Users/PC/Desktop/oobabooga_windows/text-generation-webui/models/Narwhal-Coder-13b')
    print(model)
